...
Future<void> configureDependencies() async {
  ...
  getIt.registerFactory<CharacterLocalDataSource>(
        () => CharacterLocalDataSourceImpl(getIt(), getIt()),
  );
  getIt.registerFactory<CharacterApiService>(() => CharacterApiService(getIt()));

  // Repository
  getIt.registerFactory<CharacterRepository>(() => CharacterRepositoryImpl(
